...
import { deselect, hasSelection, invertSelection, reselect, selectAll, subscribeSelection } from './engine/selection';
...
registerCommand({ id: 'select.subject', label: 'Select Subject', phase: 'E' });
